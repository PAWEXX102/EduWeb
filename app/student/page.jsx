        ...
        <div className="flex flex-row  relative text-white w-full">
            ...
            <nav className="absolute flex flex-row justify-center w-full">
                <div className="flex flex-col">
                    <div className="flex flex-row bg-green-500 mt-7 pr-7 py-6 rounded-3xl xl:w-[58rem] lg:w-[30rem] md:w-[30rem] justify-between">
                        <div className="flex flex-col">
                            <h1 className="text-white font-bold lg:text-2xl md:text-lg text-gray-50 px-5">Moduł 1 Sekcja 1</h1>
